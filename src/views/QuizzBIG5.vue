  ...
  data () {
    return {
      statements: [ { text: 'Am the life of the party.\n', choice: 3 },
                    ...
                    { text: 'Am not interested in other peoples problems.\n', choice: 3 },
                    ...
                    { text: 'Dont like to draw attention to myself.\n', choice: 3 },
