...
export default {
  ...
  data () {
    return {
      ...
      { text: 'Vous pensez souvent à ce que vous auriez dû dire dans une conversation après qu\'elle ait eu lieu.\n', choice: 4 },
      ...
      { text: 'Vous vous inquiétez rarement d\'avoir fait bonne impression à quelqu\'un que vous avez rencontré.\n', choice: 4 },
      ...
      { text: 'Vous avez tendance à vous remémorer les erreurs du passé.\n', choice: 4 },
      ...
      { text: 'Lorsque vous rencontrez un groupe de personnes que vous ne connaissez pas, vous n\'avez aucun problème à vous lancer directement dans leur conversation.\n', choice: 4 },
      ...
      { text: 'Vous êtes dévoué et concentré sur vos objectifs, vous ne vous détournez que rarement.\n', choice: 4 },
