...
export default {
  ...
  methods: {
    openModal: function (personality) {
...
<style lang="scss" scoped>
  ...
  .card {
    border-radius: 10px;
    background-color: rgba(50, 68, 93, 0.47);
